...
const isOwner = [`${setting.ownerNumber}`,"6285869074622@s.whatsapp.net","62895333501279@s.whatsapp.net"].includes(sender) ? true : false
...
const gurbot = '6285869074622@s.whatsapp.net'
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝐄𝐥𝐚𝐢𝐧𝐚`
...
var bg_lexxy = '6285869074622@s.whatsapp.net'
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by Elaina' })
}
console.log(feta)
}
break
...
.then(data => {
var opt = { packname: 'Elaina', author: '𝐈𝐠 𝐟𝐡𝐥.𝐝𝐱𝟏𝟕' }
...
var dev = '6285869074622@s.whatsapp.net'
